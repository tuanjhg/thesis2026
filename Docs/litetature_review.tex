...
Thứ ba, bài toán phát hiện trong thực tế phức tạp hơn do tấn công đa vectơ, tấn công tốc độ thấp và đặc trưng lưu lượng biến thiên theo thời gian. Các mô hình đơn lẻ thường khó đồng thời đạt độ chính xác cao, độ trễ thấp và tính ổn định khi dữ liệu mất cân bằng~\cite{chen2016xgboost,mdpi2025transformer}.
...
\textbf{(3) ML/DL cho phát hiện và dự báo DDoS.} Nhóm mô hình truyền thống (Random Forest, XGBoost, LightGBM) mạnh về tốc độ suy luận; nhóm DL/Transformer mạnh về biểu diễn phụ thuộc thời gian nhưng thường đánh đổi bằng độ trễ cao hơn~\cite{breiman2001rf,chen2016xgboost,vaswani2017attention,mdpi2025transformer}.

\begin{table}[H]
\centering
\caption{So sánh các phương pháp ML trong phát hiện và dự báo DDoS}
\label{tab:ml_comparison}
\begin{tabularx}{\textwidth}{lXXccc}
\toprule
\textbf{Phương pháp} & \textbf{Ưu điểm chính} & \textbf{Dataset} & \textbf{Độ trễ} & \textbf{F1 (điển hình)} & \textbf{Tài liệu} \\
\midrule
Random Forest       & Ổn định, dễ diễn giải          & NSL-KDD, CICIDS2017       & TB         & 0.92--0.95 & \cite{breiman2001rf} \\
XGBoost / LightGBM  & Nhanh, chính xác cao           & CICDDoS2019, CICIDS2018   & Thấp       & 0.95--0.99 & \cite{chen2016xgboost,ke2017lightgbm} \\
CNN + GRU/LSTM      & Học đặc trưng cục bộ + tuần tự & CICDDoS2019               & Trung bình & 0.94--0.98 & \cite{scifrep2025cnngru} \\
Transformer         & Phụ thuộc dài hạn, song song   & CICDDoS2019               & Cao        & 0.95--0.99 & \cite{mdpi2025transformer} \\
\bottomrule
\end{tabularx}
\end{table}
